...
class EstacaoAdmin(admin.ModelAdmin):
    ...
    list_filter = ('uf', 'responsabilidade_operacao', 'outorga_estacao', 'status_operacao', 'sfn', 'modelo_tx', 'tipo_torre', 'status_telemetria', 'proprietario_terreno', 'energia_paga_por', 'agua_paga_por', 'aluguel_pago_por', 'iptu_pago_por','seguro_estacao')  # Fields for filtering
